...
PITCHES_DICT = {'C-1': 0.0,
                ...
                'C4':261.63, 'C#4':277.18, 'D4':293.66, 'D#4':311.13, 'E4':329.63, 'F4':349.23, 'F#4':369.99, 'G4':392.00, 'G#4':415.30, 'A4':440.00, 'A#4':446.16, 'B4':493.88,
                'C5':523.25, 'C#5':554.37, 'D5':587.33, 'D#5':622.25, 'E5':659.25, 'F5':698.46, 'F#5':739.99, 'G5':783.99, 'G#5':830.61, 'A5':880.00, 'A#5':932.33, 'B5':987.77,
                'C6':1046.50, 'C#6':1108.73, 'D6':1174.66, 'D#6':1244.51, 'E6':1318.51, 'F6':1396.91, 'F#6':1479.98, 'G6':1567.98, 'G#6':1661.22, 'A6':1760.00, 'A#6':1864.66, 'B6':1975.53,
                'C7':2093.00, 'C#7':2217.46, 'D7':2349.32, 'D#7':2489.02, 'E7':2637.02, 'F7':2793.83, 'F#7':2959.96, 'G7':3135.96, 'G#7':3322.44, 'A7':3520.00, 'A#7':3729.31, 'B7':3951.07,
                'C8':4186.01, 'C#8':4434.92, 'D8':4698.63, 'D#8':4978.03, 'E8':5274.04, 'F8':5587.65, 'F#8':5919.91, 'G8':6271.93, 'G#8':6644.88, 'A8':7040.00, 'A#8':7458.62, 'B8':7902.13} # A4 = 440 Hz, from https://pages.mtu.edu/~suits/notefreqs.html
...
def tune():
    ...
    print("begin audio stream")
    
    # set up pitch
    win_s = 4096 # fft size (size of the input sequence)-- buffer_size*4?
    hop_s = buffer_size # hop size = buffer size
    pitch_o = aubio.pitch("default", win_s, hop_s, samplerate) # find fundamental frequency, try aubio.notes
    ...
    while running:
        try:
            ...
            if pitch > 0 and PITCHES_DICT[note] > 0: # ignore bad domain inputs
                cents = int(1200 * math.log(pitch / PITCHES_DICT[note]) / math.log(2)) # from http://hyperphysics.phy-astr.gsu.edu/hbase/Music/cents.html
            else:
                continue 
